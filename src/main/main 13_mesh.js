...
import doortextureimg from "../../dist/img/men.jpg";
...
//导入纹理
const doorColorTexture = new THREE.TextureLoader().load(textureyueqiu);
...
//纹理显示设置
doorColorTexture.minFilter=THREE.LinearMipmapNearestFilter
doorColorTexture.magFilter=THREE.LinearMipmapLinearFilter
